...
**09-19 LoRa HDG M·함대 실시간 그래프 (F3·F4, 실물 적용 전)**
- 무선 v2 24바이트에 HDG M을 추가하고 Fleet BLE v3를 34바이트로 확장했다. 수신기부터 올린 뒤 송신기를 올려야 한다.
- 앱은 지도 배 표식에 SOG·HDG를 표시하고 최근 5분 SOG, HDG/COG, 힐/피치, RSSI/SNR 그래프를 그린다.
- PPS 전에도 HDG·자세·REC·배터리는 보내며 위치·SOG·COG만 비운다. 코드·호스트 시험·빌드·실물 시험은 진행 중이다.
...
| ID | 요구사항 | 기능 | 코드 | 빌드 | 보드 시험 방법 | 합격 기준 | 보드 시험 | 증거 |
|---|---|---|---|---|---|---|---|---|
| L01 | F1 | 켤 때 설정 줄 · 전파시간 | ✅ | 🔶 | 켤 때 · `lora` | 922.55 · SF7 · BW500 · 8 dBm · 약 15420 us | 🔶 옛 22바이트판 14144 us만 확인. 현재 24바이트판 재측정 필요 | |
...
| L07 | F3 | 24바이트 실시간 패킷·GPS PPS 32슬롯·20분 holdover·PPS 전 확인 신호·송수신 일꾼·off sleep | ✅ | 🔶 | 워치에서 배 번호 저장 → 장거리 시작 → 실외 60초 → 종료 | 시작 전/종료 후 SX1262 sleep · PPS 전 HDG 수신 · PPS 뒤 송신 약 60 · 실패/차례 놓침 0 | 🔶 09-18 옛 22바이트판 PPS 전 3/3 수신. 현재 24바이트판 재시험·실외 PPS 1 Hz·종료 sleep 남음 | |
| L08 | F4 | 수신 패킷 해석·최근 3초 heard·`lora peers`·번호 tie 충돌 | ✅ | 🔶 | 두 보드: 송신 boat 1 / 수신 boat 0 watch+peers | 좌표·SOG·COG·HDG 일치 · CRC/버림 0 · 3초 뒤 목록에서 사라짐 | 🔶 09-18 무선 v1/BLE v2만 확인. 무선 v2/BLE v3와 HDG 실물 확인 남음 | |
